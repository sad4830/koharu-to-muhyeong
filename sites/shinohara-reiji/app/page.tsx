...
const techniques = [
  {
    ...
    rule: "즉시 발사 · 선 1가닥 · 최대 300 MJ · 사거리 60 m · 최대 700 m/s · 쿨타임 1지문",
    cost: "발사에 쓴 선은 즉시 사라지고 반동을 사용한 팔로 받는다. 그 팔은 다음 1지문 동안 새 선을 설치하거나 구조봉으로 공격할 수 없다. 200 MJ 이상으로 쏘면 이 제한이 2지문으로 늘어난다.",
  },
  {
    no: "A–02",
    name: "강제 회수",
  ...
  },
  {
    ...
    rule: "즉시 반격 · 선 1가닥 · 최대 400 MJ · 방향 전환 최대 60도 · 쿨타임 2지문",
    cost: "반격에 쓴 선은 즉시 사라진다. 반격 순간에는 제자리에 버텨야 하므로 《회수 보행》을 함께 쓸 수 없다. 사용한 팔의 구조봉 타격 위력이 다음 1지문 동안 절반으로 줄어든다. 300 MJ 이상을 되돌리면 그 팔을 2지문 동안 어깨 위로 들 수 없고, 400 MJ를 넘은 충격은 막지 못한다.",
  },
  {
    no: "A–04",
    name: "회수 보행",
  ...
  },
  {
    ...
    rule: "준비 1지문 · 즉시 압착 · 선 3가닥 · 반경 14 m · 최대 합계 900 MJ · 쿨타임 3지문",
  ...
  },
  {
    ...
    name: "하중 인계",
    role: "최대 출력",
    copy: "네 가닥에 모은 힘을 구조봉이 닿은 한곳에 전부 터뜨린다. 주변 20 m를 안쪽으로 짓눌러 중형 건물 1채를 파괴할 수 있는 총 2 GJ의 충격을 낸다.",
    rule: "충전 2지문 · 즉시 방출 · 선 4가닥 · 총 2 GJ · 영향 반경 20 m · 쿨타임 5지문",
      ...
      <section className="ability-section" id="ability">
        ...
        <div className="ability-principle">
          ...
          <p>
            ...
            공격에도 연결할 수 없다. 한 가닥에는 최대 500 MJ, 네 가닥에는 총 2 GJ까지 힘을 모은다. 자신의 영력으로
            한 지문에 총 1 GJ를 채울 수 있고, 적의 물리 공격을 받아 저장할 때는 원래 힘의 80%만 남는다.
          </p>
        </div>
