...
const techniques = [
  ...
  },
  {
    ...
    name: "하중 인계",
    role: "최대 출력",
    copy: "세 개 이상의 고정점에 쌓인 장력을 한 지점으로 넘겨 충돌을 밀어내거나, 지면에 내리꽂아 전방을 제압한다. 최대 위력은 소형 건물 1채 파괴급(총 1.2 GJ)이며, 영향 반경은 18 m가 상한이다.",
    rule: "최대 저장량의 절반 이상(600 MJ) 필요 · 즉시 방출 · 사용 후 능력 5지문 봉인",
      ...
      <section className="ability-section" id="ability">
        ...
        <div className="ability-principle">
          ...
          <p>
            ...
            한 가닥에는 최대 300 MJ, 전체에는 최대 1.2 GJ까지 저장할 수 있으며 저장 과정에서 최소 20%가
            열과 진동으로 손실된다.
          </p>
        </div>
