...
function SecretProfile() {
  return (
    <div className="profile-copy view-enter" id="profile-content" tabIndex={-1}>
      ...
      <nav className="record-index" aria-label="비밀 프로필 기록 목차">
        <span>RECORD INDEX</span>
        <a href="#secret-record">신상</a>
        <a href="#secret-personality">성격</a>
        <a href="#secret-preferences">L / H / S</a>
      ...
      >
        ...
        <p>
          옅은 보랏빛이 감도는 먹회색 머리카락을 허벅지 아래까지 길러 양옆으로 굵게
          땋았다. 무거운 앞머리가 왼쪽 눈을 반쯤 가리고, 양쪽 앞머리에는 은색 일자
          핀을 두 개씩 나란히 꽂는다. 크고 둥근 연보라색 눈과 옅게 달아오른 뺨,
          코 옆의 작은 점이 눈에 띈다. 다만 긴 앞머리 아래의 왼쪽 눈은 상대가 자리를
          뜨거나 시선을 돌릴 때 훨씬 오래 움직임을 좇는다. 웃을 때 두 손으로 하트를
          만드는 습관은 연인과 찍은 첫 사진의 자세를 반복하는 것이다. 압박을 받으면
          은색 머리핀 두 쌍이 정확히 평행한지 손끝으로 확인한다.
        </p>
        <p>
          힐그램 안에서는 흰색 하이넥 셔츠형 원피스와 흰 바지를 겹쳐 입고, 검은
          구속줄이 위팔과 손목, 허리, 발목을 고정한다. 가늘고 작은 체구지만 자세를
          흐트러뜨리는 일이 거의 없다. 검은 허리끈을 유독 단단히 조여 매며 풀린
          매듭을 보면 대화를 멈추고 바로잡는다. 입소 전에는 연인의 기념일마다 같은
          라일락색 옷과 하트 장신구를 착용했다. 지금 남은 라일락색 박음질은 본인이
          허락받은 유일한 장식이다.
        </p>
      </section>
      ...
      >
        ...
        <p>
          ...
          뒤에만 확정됩니다. 전체 선관은 최대 3명까지 가능합니다.
        </p>
        <RelationshipHooks />
      </section>
    </div>
...
export default function ProfileClient() {
  return (
    <div className="site-shell sealed-shell" data-theme="sealed">
      <a className="skip-link" href="#profile-content">본문으로 건너뛰기</a>

      <header className="topbar">
        <a className="wordmark" href="#top" aria-label="미카게 시즈쿠 비밀 프로필 처음으로">
          <span lang="ja">御影 雫</span>
          <small>HILGRAM</small>
        </a>
        <p className="sealed-badge">운영진 열람용</p>
      </header>
