...
const lines = [
  "아, 잠깐만요. 지금 도망치시면 표본이 움직이잖아요. 맞다, 그래서 쫓는 게 재밌는 거였죠! 뛰세요. 더 빨리요!",
  "죽이지 않습니다. 망가지기 직전까지 정확히, 예쁘게, 되돌릴 수 있게 만들 뿐이에요. 되돌릴지는 나중 문제고요.",
  "선택지는 두 개예요. 왼팔이 굳거나, 오른발이 붙거나. 아, 세 번째도 있네요. 저를 물어뜯는 것! 최고예요!",
  "싫다고요? 아주 좋아요. 거부 반응은 선명해야 하니까요. 자, 그럼 주변 조건부터 조금 망쳐 볼까요?",
];
    ...
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section className="profile-section" id="profile">
          ...
          <div className="profile-columns">
            ...
            <article className="temperament-panel">
              ...
              <blockquote>“정답은 필요 없어요. 터질 때 무슨 색인지 보여 주세요!”</blockquote>
            </article>
          </div>
        ...
        <section className="final-section">
          <h2>문을 두드려 주세요.<br />열어 드린다고 약속은 못 하지만.</h2>
