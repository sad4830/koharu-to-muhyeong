  ...
  return (
    <div className={`console-shell ${pulse === 6 ? "console-ready" : ""}`}>
      ...
      <div className="console-actions">
        ...
        <button
          type="button"
          onClick={() => spendPulse(2, "직선 폐로 · 쿨타임 3지문")}
    ...
    <div className="ability-archive">
        ...
        <article className="ability-panel" role="tabpanel">
          ...
          <div className="rule-grid">
            ...
            <div>
              ...
              <p className="tech-penalty">
                <strong>공격 패널티</strong>
                강화 타격은 빗나가거나 막혀도 사용한 펄스가 돌아오지
                않으며, 펄스를 소비한 가속·강화 공격으로는 새 펄스를
                얻을 수 없습니다. 2펄스 타격 후 사용한 팔이나 다리는
                1지문 동안 저려, 같은 부위로 강화 타격을 연속 사용할 수
                없습니다.
              </p>
            </div>
            <div>
          ...
          <div className="maximum-box">
            ...
            <div className="maximum-copy">
              ...
              <p className="tech-penalty">
                <strong>공격 패널티</strong>
                명중 여부와 관계없이 6펄스를 전부 소모합니다. 사용 후
                2지문 동안 새 펄스를 얻을 수 없으며, 전력 질주와 정교한
                무기 조작이 어려워집니다.
              </p>
            </div>
          </div>
        ...
        <article className="ability-panel" role="tabpanel">
          ...
          <div className="rule-grid">
            ...
            <div>
              ...
              <p className="tech-penalty">
                <strong>공격 패널티</strong>
                해머 공격이 빗나가거나 막히면 표식이 남지 않습니다.
                《추뢰 폐로》를 한 번 발동하거나 표식이 남은 장비·옷을
                벗으면 표식은 즉시 소멸합니다.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                방전을 일으킵니다. 지속 1지문, 쿨타임 3지문이며 적을
                추적하거나 벽을 관통하지 않습니다.
              </p>
              <p className="tech-penalty">
                <strong>공격 패널티</strong>
                발동한 지문에는 쇄뢰로 근접 공격하거나 다른 폐로를 함께
                발동할 수 없습니다. 회로가 끊기거나 빗나가도 2펄스는
                돌아오지 않습니다.
              </p>
            </div>
            <div>
              ...
              <p className="tech-penalty">
                <strong>공격 패널티</strong>
                성공 여부와 관계없이 3펄스와 이동 전극 표식이 소모되며,
                다음 1지문 동안 새로운 이동 전극을 부여할 수 없습니다.
              </p>
            </div>
          </div>
          <div className="maximum-box">
            ...
            <div className="maximum-copy">
              ...
              <p className="tech-penalty">
                <strong>공격 패널티</strong>
                명중 여부와 관계없이 6펄스와 전극 3개가 모두 소모됩니다.
                사용 후 성물의 모든 능력은 6지문 동안 봉인됩니다.
              </p>
            </div>
          </div>
        </article>
      ...
      <details className="judgement-note">
        ...
        <p>
          ...
          파괴 효과도 없습니다. 아카네 본인은 II등급 능력의 최대 출력
          이하로 환산되는 자연·인공 전기와 II등급 이하의 천둥·번개·전기성
          능력 및 공격에 완전 면역입니다. I등급·사도급·권능의 전기는
          정상적으로 방어 판정을 거쳐 피해를 받으며, 전기 공격은 피해
          여부와 관계없이 펄스를 충전하지 않습니다. 전기로 발생한 폭발·
          충격파·굉음·건물 붕괴·파편·화재와 전기가 흐르는 무기의 물리
          공격도 그대로 받습니다. 장비와 아군은 보호되지 않으며, 전기
          그 자체로 변신하거나 전력망·기상·자기력·전자기파를 조작할 수도
          없습니다.
        </p>
      </details>
    </div>
