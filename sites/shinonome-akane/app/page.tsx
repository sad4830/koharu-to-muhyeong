...
const limits = [
  {
    title: "피해 보존",
    body: "전기 이외의 공격을 받아 펄스를 얻더라도 상처와 통증은 줄어들지 않습니다. 무리한 축전은 그대로 패배로 이어집니다.",
  },
  {
    title: "직선 경로",
  ...
  {
    title: "침수 환경",
    body: "아카네는 감전되지 않지만, 넓은 물과 금속 바닥에서는 방전 경로가 임의로 접지됩니다. 아군과 주변 시설은 보호되지 않습니다.",
  },
];
        ...
        <article className="ability-panel" role="tabpanel">
          ...
          <div className="rule-grid">
            ...
            <div>
              <h4>③ 전기 완전 면역</h4>
              <p>
                자연·인공·이능을 가리지 않고 모든 천둥, 낙뢰, 번개와
                전기에 완전 면역입니다. 출력과 관계없이 감전·전기성
                열·마비·천둥의 충격과 굉음으로 피해를 받지 않습니다.
              </p>
            </div>
            <div>
              <h4>④ 제한과 패널티</h4>
              <p>
                전기 면역은 펄스를 충전하지 않습니다. 자해·벽 두드리기·
                합의한 공격으로도 충전할 수 없습니다. 5펄스부터 이명과
                손떨림이 생기며, 6펄스를 2지문 넘게 보유하면 전량이
                소멸합니다. 전기 이외의 공격으로 입은 피해는 그대로
                남습니다.
              </p>
            </div>
          </div>
          <div className="maximum-box">
            ...
            <p>
              ...
              전환과 순간이동은 불가능하며, 사용 후 2지문 동안 전력
              질주와 정교한 무기 조작이 어려워집니다.
            </p>
          </div>
        </article>
      ) : (
    ...
    <main className="site-shell">
      ...
      <section className="combat-section section-wrap">
        <div className="section-heading compact">
          ...
          <p>
            모든 전기 피해는 완전히 무효화하지만 물리 피해를 지우지는
            못합니다. 다치기 전에 전로를 완성해야 하는 고위험 근접
            제압형입니다.
          </p>
        </div>
